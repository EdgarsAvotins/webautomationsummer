...
#   el = get_element(:xpath, '//*[@class="user-account-port"]')
#   $driver.action.move_to(el).perform
#   get_element(:xpath, '//*[@id="nav-user-account"]//*[@class="join-btn"]').click
# end
# And (/^i input my details in registration form and create account$/) do
#   @mail=Faker::Internet.email
#   @pass=Faker::Internet.password
#   get_element(:xpath, '//*[@class="input-box"]//*[@id="ws-xman-register-email"]').click
#   get_element(:xpath, '//*[@class="input-box"]//*[@id="ws-xman-register-email"]').send_keys(@mail)
#   elpass = get_element(:xpath, '//*[@id="ws-xman-register-password"]').click
#   #$driver.action.move_to(elpass).perform.click.perform
#   get_element(:xpath, '//*[@class="input-box"]//*[@id="ws-xman-register-password"]').send_keys(@pass)
#   get_element(:xpath, '//*[@ id="ws-xman-register-submit"]').click
#   get_element(:xpath, '//*[@class="close-layer"]').click
#   sleep(10)
# end
#
